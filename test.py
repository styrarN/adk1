...
class BasicTests(unittest.TestCase):
    ...
    def test_program(self):
        ...
        self.assertEqual(os.system('python3 reader.py tågpladder --stupid 1> /dev/null'), 0)
        self.assertEqual(os.system('python3 reader.py för 1> /dev/null '), 0)
        self.assertEqual(os.system('python3 reader.py regering 1> /dev/null'), 0)
